  ...
  return (
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          <h3 className="text-2xl font-bold text-white text-center mb-8">Our Team</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
